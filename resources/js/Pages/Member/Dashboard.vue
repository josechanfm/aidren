        ...
        <div class="col-span-4 md:col-span-3 bg-white p-4 rounded-lg shadow order-2 md:order-1">
            <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                ...
                <h1 class="mt-8 text-2xl font-medium text-gray-900">
                    Empowering Resolution Through Innovation
                </h1>
                <p class="mt-6 text-gray-500 leading-relaxed">
                    Welcome to our AI-powered Dispute Resolution Expert Network, where technology meets expertise. We
                    connect individuals and organizations with a community of skilled professionals dedicated to
                    resolving conflicts efficiently and effectively. Our platform harnesses artificial intelligence to
                    streamline the resolution process, making it faster, fairer, and more accessible for everyone.
                </p>
            </div>
        ...
        <div class="col-span-4 md:col-span-1 bg-white p-4 rounded-lg shadow order-1 md:order-2">
            ...
            <ul class="space-y-2">
                <li v-for="team in $page.props.auth.user.all_teams" :key="team.id" class="flex justify-between items-center bg-white p-3 rounded shadow">
                        ...
                        <span class="text-gray-600" v-if="team.membership">Role: {{ team.membership.role }}</span>
