...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
                ...
                <div class="mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <DropdownLink :href="route('member.portfolios.index')">
                                            Profile
                                        </DropdownLink>
                        ...
                        <div class="-me-2 flex items-center sm:hidden">
                            <form @submit.prevent="logout">
                                <ResponsiveNavLink as="button" class="text-amber-800 hover:text-amber-900">
                                    Log Out
                                </ResponsiveNavLink>
                            </form>
            ...
            <!-- Page Heading -->
            <header v-if="$slots.header" class="bg-amber-50 shadow">
